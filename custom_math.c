 ...
 * The lookup table has the logarithms of values between 1.000 and 9.999 with a
 * step size of 0.001. This function then recursively scales all given values by multiplying/
 ...
 * step size of 0.001, then the closest value will be returned from the table
 */
double ln(double x) {
    ...
    while (x > 1.001) {
        ...
        result += lookup_ln(closest_entry);
